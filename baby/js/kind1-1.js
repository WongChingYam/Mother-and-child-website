$(function(){ 
    ...
    $.ajax({
        ...
        success:function(data){ 
            ...
            var html = template("productInfo_temp",datas);
    ...
    //选择不同颜色与尺码 
    $("#sel1").on("click","a",function(){
        $(this).siblings().css("borderColor","#b8b7bd").children("span").removeClass("i_selected")
        $(this).css("borderColor","#f43499").children().last().addClass("i_selected");            
    });
    $("#sel2").on("click","a",function(){
        $(this).siblings().css("borderColor","#b8b7bd").children("span").removeClass("i_selected")
        $(this).css("borderColor","#f43499").children().last().addClass("i_selected");            
    });
